...
|[Построить модель, которая предскажет температуру стали.](temperature)|В целях снижения потребления электроэнергии на этапе обработки стали научиться предсказывать температуру стали, на основании известных данных о пройденных технологических этапов|Pandas<br/>Matplotlib<br/>Seaborn<br/>Scikit-learn<br/>CatBoost|
